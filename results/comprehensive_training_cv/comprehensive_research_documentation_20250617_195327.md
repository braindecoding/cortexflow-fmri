...
### Complete Performance Matrix (CV MSE Results)

| Method | Miyawaki | Vangerven | MindBigData | Crell | Mean | Std | CV Coeff |
|--------|----------|-----------|-------------|-------|------|-----|----------|
| CortexFlow_Lite | 0.012473 | 0.049517 | 0.058783 | 0.032714 | 0.038372 | 0.017632 | 0.4595 |
| MinD_Vis | 0.009484 | 0.048767 | 0.058001 | 0.032564 | 0.037204 | 0.018413 | 0.4949 |
| Brain_Diffuser | 0.008761 | 0.049041 | 0.058973 | 0.033010 | 0.037446 | 0.018976 | 0.5067 |
| CortexFlow_Multi-Pathway | 0.045671 | 0.061006 | 0.057083 | 0.032541 | 0.049075 | 0.011084 | 0.2259 |
| CortexFlow_Ensemble | 0.014442 | 0.046323 | 0.058614 | 0.032546 | 0.037981 | 0.016424 | 0.4324 |

### Ranking Matrix

| Method | Miyawaki | Vangerven | MindBigData | Crell | Mean Rank | Rank Std |
|--------|----------|-----------|-------------|-------|-----------|----------|
| CortexFlow_Lite | 3 | 4 | 4 | 4 | 3.75 | 0.43 |
| MinD_Vis | 2 | 2 | 2 | 3 | 2.25 | 0.43 |
| Brain_Diffuser | 1 | 3 | 5 | 5 | 3.50 | 1.66 |
| CortexFlow_Multi-Pathway | 5 | 5 | 1 | 1 | 3.00 | 2.00 |
| CortexFlow_Ensemble | 4 | 1 | 3 | 2 | 2.50 | 1.12 |

### Hypothesis Testing Summary Table

| Hypothesis | Type | Statistical Test | p-value | Result | Effect Size | Interpretation |
|------------|------|------------------|---------|--------|-------------|----------------|
| H1: MinD_Vis Consistency | Individual | Multi-criteria | 0.514502 | ✅ Supported | 2/3 | Stable performance |
| H2: CortexFlow_Lite Consistency | Individual | Multi-criteria | 0.693292 | ✅ Supported | 2/3 | Predictable results |
| H3: Multi-Pathway Consistency | Individual | Multi-criteria | 0.005644 | ❌ Rejected | 1/3 | Dataset specialist |
| H4: Ensemble Consistency | Individual | Multi-criteria | 0.598611 | ✅ Supported | 2/3 | Balanced performance |
| H5: Brain_Diffuser Consistency | Individual | Multi-criteria | 0.563499 | ❌ Rejected | 1/3 | Modality specialist |
| H6: Complexity Matching | Architecture-Dataset | Pearson Correlation | 0.599521 | ❌ Rejected | r=-0.125 | No linear relationship |
| H7: Modality Specialization | Specialization | Descriptive Analysis | N/A | ✅ Strong Evidence | Large | Clear patterns |
